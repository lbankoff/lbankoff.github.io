...
function GetPrice(seat, row)
{
	...
	{
		if(seat >= 01 && seat <= 32)
			document.getElementById("Price Value").innerHTML = "Стоимость билета - 3000 рублей";
		else
	...
	if(row == 03)
	{
		if(seat >= 01 && seat <= 03 || seat >= 36 && seat <= 38)
			document.getElementById("Price Value").innerHTML = "Стоимость билета - 2500 рублей";
		else if(seat >= 04 && seat <= 35)
			document.getElementById("Price Value").innerHTML = "Стоимость билета - 2800 рублей";
		else
			document.getElementById("Price Value").innerHTML = "Выберите ряд и место, чтобы узнать цену";
	}
	if(row == 04)
	...
	if(row == 06)
	{
		if(seat >= 01 && seat <= 07 || seat >= 40 && seat <= 46)
			document.getElementById("Price Value").innerHTML = "Стоимость билета - 2200 рублей";
	...
	if(row == 10)
	{
		if(seat >= 01 && seat <= 07 || seat >= 41 && seat <= 49)
			document.getElementById("Price Value").innerHTML = "Стоимость билета - 2000 рублей";
	...
	if(row == 15)
	{
		if(seat >= 01 && seat <= 10 || seat >= 43 && seat <= 52)
			document.getElementById("Price Value").innerHTML = "Стоимость билета - 1800 рублей";
	...
	{
		if(seat >= 01 && seat <= 10 || seat >= 43 && seat <= 52)
			document.getElementById("Price Value").innerHTML = "Стоимость билета - 1500 рублей";
		else if(seat >= 11 && seat <= 42)
			document.getElementById("Price Value").innerHTML = "Стоимость билета - 1800 рублей";
		else
			document.getElementById("Price Value").innerHTML = "Выберите ряд и место, чтобы узнать цену";
	...
	if(row == 20)
	{
		if(seat >= 01 && seat <= 13 || seat >= 41 && seat <= 53)
			document.getElementById("Price Value").innerHTML = "Стоимость билета - 1200 рублей";
	...
	{
		if(seat >= 01 && seat <= 14 || seat >= 42 && seat <= 55)
			document.getElementById("Price Value").innerHTML = "Стоимость билета - 1000 рублей";
		else if(seat >= 15 && seat <= 41)
			document.getElementById("Price Value").innerHTML = "Стоимость билета - 1200 рублей";
		else
			document.getElementById("Price Value").innerHTML = "Выберите ряд и место, чтобы узнать цену";
